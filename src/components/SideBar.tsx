...
const Sidebar = (textSize:any) => {
	return (
		<>
			...
			<div
				id='hs-overlay-basic'
				className=' hs-overlay.hidden hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700'>
...
{/* Close sidebar Button */}
				...
				<nav className='p-6 w-full flex flex-col flex-wrap'>
					<ul className='space-y-1.5'>
						<li>
							<a
								className={`flex items-center gap-x-3 py-2 px-2.5 ${textSize} text-slate-700 rounded-md hover:bg-gray-100 dark:hover:bg-white/[.05] dark:text-slate-400 dark:hover:text-slate-300`}
								href='#'>
								<svg
